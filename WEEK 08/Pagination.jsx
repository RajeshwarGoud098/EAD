...
function StudentTable() {
  ...
  const pageSize = 5;
  const students = [
    { id: 1, name: 'Rajesh', branch: 'CSE' },
    { id: 2, name: 'Raja', branch: 'ECE' },
    { id: 3, name: 'Abhilash', branch: 'IT' },
    { id: 4, name: 'Manoj', branch: 'ME' },
    { id: 5, name: 'Thanvith', branch: 'CSE' },
    { id: 6, name: 'Vignesh', branch: 'IT' },
    { id: 7, name: 'Adithya', branch: 'CSE' },
    { id: 8, name: 'Jayanth', branch: 'ECE' },
    { id: 9, name: 'Shashi', branch: 'IT' },
    { id: 10, name: 'Naveen', branch: 'ME' },
    { id: 11, name: 'Balaraju', branch: 'CSE' },
  ];
